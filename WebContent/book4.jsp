...
if ((session.getAttribute("userid")== null) || (session.getAttribute("userid")== "")) {
	response.sendRedirect("timeout.html");
    	 ...
    	 response.sendRedirect("search.jsp");}
        	 ...
        	 if(request.getParameter("sleeper").equals("0")){
     			out.println("<html>");
     			   out.println("<head>");
...
String dtime=request.getParameter("dtime");%></p>
...
<td><h4>Class:</h4></td>
<td><input type="text" value="SLEEPER" name="clss" readonly></td>
<td><h4>Fare: ₹.</h4></td>
<td><input type="text" value="<%=request.getParameter("fare4")%>" name="fare" readonly></td>
