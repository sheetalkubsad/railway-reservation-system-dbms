...
if ((session.getAttribute("userid")== null) || (session.getAttribute("userid")== "")) {
	response.sendRedirect("timeout.html");
    	 ...
    	 if(request.getParameter("ac1").equals("0")){
    			out.println("<html>");
    			   out.println("<head>");
...
<td><h4>Class:</h4></td>
<td><input type="text" value="AC 1" name="clss" readonly></td>
<td><h4>Fare: ₹.</h4></td>
<td><input type="text" value="<%=request.getParameter("fare1")%>" name="fare" readonly></td>
